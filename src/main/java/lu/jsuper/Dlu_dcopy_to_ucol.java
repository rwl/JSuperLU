...
public class Dlu_dcopy_to_ucol {
	 ...
	 */
		...
		if ( ksupno != jsupno ) { /* Should go into ucol[] */
			...
			while ( new_next > nzumax[0] ) {
			    if ((mem_error = dLUMemXpand(jcol, nextu, MemType.UCOL, nzumax, Glu)) != 0)
				return (mem_error);
			    ucol = Glu.ucol;
			    if ((mem_error = dLUMemXpand(jcol, nextu, MemType.USUB, nzumax, Glu)) != 0)
				return (mem_error);
			    usub = Glu.usub;
			    lsub = Glu.lsub;
			}
