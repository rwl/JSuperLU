/*! @file Dlu_heap_relax_snode.java
...
public class Dlu_heap_relax_snode {
	 ...
	 * </pre>
	 */
	public static void heap_relax_snode(
		     final     int n,
		     int       et[],           /* column elimination tree */
		     final int relax_columns,  /* max no of columns allowed in a
						 relaxed snode */
	    ...
	    if ( iwork == null ) ABORT("SUPERLU_MALLOC fails for iwork[]");
	    inv_post = iwork + n+1;
	    ...
	    if ( PRNTlevel>=1 ) {
	    System.out.printf(".. heap_snode_relax:\n" +
